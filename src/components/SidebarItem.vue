<template>
  <router-link
    ...
    class="mb-1 text-[10px] rounded-xl relative items-center py-[8px] pl-[5px] pr-[10px] w-full flex justify-start text-sm font-roboto hover:text-[#FF5B00] group hover:bg-[#FF5B00]/20 transition duration-150"
  >
