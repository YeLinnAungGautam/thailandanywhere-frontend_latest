...
export const useReservationStore = defineStore("reservation", {
  ...
  actions: {
    ...
    async updateTravellerAction(data, id) {
      try {
    ...
    async deleteTravellerImageAction(id) {
      try {
    ...
    async exportTaxExcelFile(params) {
      try {
        const response = await axios.get("/reservations/export/excel", {
          params: params,
        });
        console.log(response);
        return response.data;
