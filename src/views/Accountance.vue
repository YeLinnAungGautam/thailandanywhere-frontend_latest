  ...
  <Layout>
    <div class="min-h-auto bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div
          @click="navigateTo('/invoice_audit')"
        ...
        >
          ...
          <div class="p-6 relative z-10">
            <div class="flex items-center justify-between mb-4">
              ...
              >
                <svg
                  ...
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  class="lucide lucide-between-horizontal-end-icon lucide-between-horizontal-end"
                >
            ...
            <p class="text-gray-500 text-sm">
              Account head , account class & chart of account
            </p>
          </div>
        </div>
        ...
        <!-- 1. Sales Analytics -->
        <div
          @click="navigateTo('/product_income_checker')"
          class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden border border-gray-100 hover:border-blue-300 transform hover:-translate-y-1"
        >
          <div
            class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-400 to-blue-600 rounded-bl-full opacity-10 group-hover:opacity-20 transition-opacity"
          ...
          <div class="p-6 relative z-10">
            ...
            <p class="text-gray-500 text-sm">Income Checker for company.</p>
          </div>
        </div>

        <div
          @click="navigateTo('/receiptable_checker')"
          class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden border border-gray-100 hover:border-blue-300 transform hover:-translate-y-1"
        >
          <div
            class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-400 to-blue-600 rounded-bl-full opacity-10 group-hover:opacity-20 transition-opacity"
          ...
          <div class="p-6 relative z-10">
            ...
            <p class="text-gray-500 text-sm">Receivable Checker for company.</p>
          </div>
        </div>

        <div
          @click="navigateTo('/data_verify')"
          class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden border border-gray-100 hover:border-blue-300 transform hover:-translate-y-1"
        >
          <div
            class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-400 to-blue-600 rounded-bl-full opacity-10 group-hover:opacity-20 transition-opacity"
          ...
          <div class="p-6 relative z-10">
            ...
            <p class="text-gray-500 text-sm">
              Data verify, Duplicate checker, Bank verify, Transfer checker
            </p>
          </div>
        </div>

        <div
          @click="navigateTo('/cash_book')"
          class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden border border-gray-100 hover:border-blue-300 transform hover:-translate-y-1"
        >
          <div
            class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-400 to-blue-600 rounded-bl-full opacity-10 group-hover:opacity-20 transition-opacity"
          ...
          <div class="p-6 relative z-10">
            ...
            <h3 class="text-xl font-semibold text-gray-800 mb-2">Cash Book</h3>
            <p class="text-gray-500 text-sm">
              Cash book, Cash structure, Internal transfer.
            </p>
          </div>
        </div>

        <div
          @click="navigateTo('/tax_receipt')"
          class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden border border-gray-100 hover:border-blue-300 transform hover:-translate-y-1"
        >
          <div
            class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-400 to-blue-600 rounded-bl-full opacity-10 group-hover:opacity-20 transition-opacity"
          ...
          <div class="p-6 relative z-10">
            ...
            <p class="text-gray-500 text-sm">
              Tax receipt connect with multiple bookings.
            </p>
          </div>
        </div>

        <div
          @click="navigateTo('/bank_statement_list')"
          class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden border border-gray-100 hover:border-blue-300 transform hover:-translate-y-1"
        >
          <div
            class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-400 to-blue-600 rounded-bl-full opacity-10 group-hover:opacity-20 transition-opacity"
          ...
          <div class="p-6 relative z-10">
            ...
            <p class="text-gray-500 text-sm">
              Bank Statement for company banking.
            </p>
          </div>
        </div>

        <div
          @click="navigateTo('/bank_statement_purchese')"
          class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden border border-gray-100 hover:border-blue-300 transform hover:-translate-y-1"
        >
          <div
            class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-400 to-blue-600 rounded-bl-full opacity-10 group-hover:opacity-20 transition-opacity"
          ...
          <div class="p-6 relative z-10">
            ...
            <p class="text-gray-500 text-sm">Bank parchase for company.</p>
          </div>
        </div>
      </div>
    </div>
