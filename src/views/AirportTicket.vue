<template>
  ...
  >
    ...
    <div class="flex items-center justify-between mb-8">
      <div class="">
        <input
          ...
          placeholder="Search Airport Ticket..."
        />
      ...
      <div class="space-x-3">
        ...
        <Button :leftIcon="PlusIcon" @click="AirportCreate"> Create </Button>
      </div>
    </div>
      ...
      <table class="w-full">
        ...
        <tbody class="divide-y divide-gray-100">
          <tr
            ...
            v-for="(r, index) in airports?.data"
            :key="index"
          >
            ...
            <td class="p-3 text-sm text-gray-700 whitespace-nowrap">
              <div class="flex items-center gap-2">
                <router-link :to="'/airport/update/' + r.id + '/view'">
                  <button
                ...
                <router-link :to="'/airport/update/' + r.id + '/edit'">
                  <button
    ...
    <!-- pagination -->
    <Pagination v-if="!loading" :data="airports" @change-page="changePage" />
  </div>
</template>
...
const { airports, loading } = storeToRefs(airportStore);
