...
const addNewHandler = async () => {
  ...
  try {
    ...
    editModalOpenHandler(response.result);
    cityModalOpen.value = true;
    carNumberListShow.value = !carNumberListShow.value;
        ...
        <table class="w-full">
          ...
          <tbody class="divide-y divide-gray-100">
            ...
            >
              ...
              <td>
                <p v-for="d in driver?.infos" :key="d.id" class="text-xs">
                  {{ d.is_default == 1 ? d.car_number : " " }}
                </p>
              </td>
              <td
      ...
      >
        ...
        >
          ...
          <div class="text-end space-x-2">
            <Button type="submit" v-if="!formData.id"> Create & Next </Button>
            <Button type="submit" v-if="formData.id"> Update </Button>
            <Button
              type="button"
              v-if="formData.id"
        ...
        <div v-if="carNumberListShow || createFormShow">
          ...
          <div
            v-if="createFormShow"
            class="bg-white p-4 rounded-md shadow-md mb-2 mt-4 border border-gray-400 space-y-4"
          >
            <div class="mb-2 space-y-1">
              <label for="name" class="text-sm text-gray-800">Car Number</label>
              <input
                type="text"
          ...
          <div class="rounded-md bg-white mb-2 mt-4" v-if="carNumberListShow">
