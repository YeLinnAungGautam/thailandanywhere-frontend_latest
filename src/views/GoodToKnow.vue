...
const productType = computed(() => {
  return props.type === "hotel" ? "Hotel" : "Product";
});
...
Product Name: ${props.productData?.name || "N/A"}
Description: ${props.productData?.description || "N/A"}
Full Description: ${props.productData?.full_description || "N/A"}
Location: ${
      props.productData?.location_map_title ||
      props.productData?.city?.name ||
      "N/A"
    }
Check-in: ${props.productData?.check_in || "N/A"}
Check-out: ${props.productData?.check_out || "N/A"}
Cancellation Policy: ${props.productData?.cancellation_policy || "N/A"}
Rating: ${props.productData?.rating || "N/A"}
`;

    const prompt = `You are a travel expert creating "Good to Know" tips for a ${props.type}.
...
- Time/Schedule: fa-solid fa-clock, fa-solid fa-calendar, fa-solid fa-calendar-check
- Facilities: fa-solid fa-wifi, fa-solid fa-swimming-pool, fa-solid fa-dumbbell, fa-solid fa-utensils
- Payment: fa-solid fa-credit-card, fa-solid fa-wallet, fa-solid fa-money-bill-wave
- Policy/Info: fa-solid fa-shield-alt, fa-solid fa-file-alt, fa-solid fa-info-circle, fa-solid fa-ban
- Services: fa-solid fa-concierge-bell, fa-solid fa-car, fa-solid fa-taxi
- Safety: fa-solid fa-lock, fa-solid fa-first-aid, fa-solid fa-phone
...
Focus on practical information that guests need to know about staying at this ${props.type}.`;
    ...
    if (jsonMatch) {
      ...
      if (Array.isArray(generatedItems) && generatedItems.length > 0) {
        ...
        showToast("✅ AI generated 5 items! Review and save them.", "success");
