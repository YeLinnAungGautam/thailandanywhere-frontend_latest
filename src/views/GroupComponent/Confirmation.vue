      ...
      <div class="col-span-2 py-3 rounded-lg relative border border-gray-200">
        ...
        <div class="grid grid-cols-2 h-[46vh] overflow-y-auto px-4 gap-4">
          <div class="col-span-2 grid grid-cols-2 gap-3">
            <div>
              <p class="text-xs pb-1.5 font-medium">Slip Code *</p>
              <input
                type="text"
...
const openPassportModal = (data, index) => {
  ...
  formData.value.slip_code = data.meta.slip_code;
...
const getListAction = async () => {
  ...
  console.log(res);
  confirmationLists.value = res.result;
  loading.value = false;
};
...
const addNewAction = async () => {
  ...
  // Document type
  frmData.append("document_type", "confirmation_letter");
  ...
  frmData.append("documents[0][meta][slip_code]", formData.value.slip_code);
...
const updateAction = async () => {
  ...
  frmData.append("meta[slip_code]", formData.value.slip_code);
