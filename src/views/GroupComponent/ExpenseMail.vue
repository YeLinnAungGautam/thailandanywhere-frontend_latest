<template>
  <div class="grid grid-cols-6 gap-4">
    ...
    >
      ...
      >
        {{ is_sent_expense_mail ? "Email Sent" : "Not Sent" }}
      </p>
      ...
      <div class="grid grid-cols-1 gap-2">
        <div class="mb-2 space-y-1 col-span-2">
          ...
          <div class="pt-2 space-y-2" @click="openFileImagePicker">
            <label class="pb-2 text-xs">Proof of Expense</label>
            <div
    ...
    >
      <div class="flex justify-between items-center">
        <p class="text-lg font-medium text-[#FF613c]">Send Expense Request:</p>
...
const updateReservationAction = async () => {
  const frmData = new FormData();
  frmData.append("sent_expense_mail", is_sent_expense_mail.value ? 1 : 0);
...
const getProofImage = async () => {
  const res = await groupStore.groupDocumentList(route.query.id, {
    document_type: "expense_mail_proof",
  });
...
const getPassportImage = async () => {
  ...
  expenseList.value = res.result;
  console.log("====================================");
  console.log(expenseList.value, "this is expense list");
  console.log("====================================");
};
