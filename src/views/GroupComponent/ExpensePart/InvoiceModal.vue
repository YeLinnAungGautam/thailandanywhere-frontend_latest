      ...
      >
        ...
        >
          ...
          <div class="flex justify-end items-center gap-x-2">
            <button
              @click="openEditItemCost"
              class="px-4 py-2 bg-blue-600 flex justify-center gap-x-2 items-center text-white shadow-lg rounded-xl hover:bg-blue-700 transition-colors"
            >
              <PencilSquareIcon class="w-5 h-5" />
              <span>Edit Item Cost</span>
            </button>
            <button
              @click="handleClose"
              ...
              <div>
                ...
                <div class="relative">
                  <input
                    ...
                    :disabled="
                      !formData.product_type || loading || isAutoFilled
                    "
                    class="border text-sm border-gray-200 px-4 py-3 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-[#FF613c]/20 focus:border-[#FF613c] disabled:bg-gray-50"
                    required
                  />
            ...
            <div v-show="currentStep === 3" class="space-y-4">
              <div class="grid grid-cols-2 gap-x-4">
                ...
                >
                  ...
                  >
                    <div
                      class="flex justify-between space-x-3 items-start py-1"
                    >
                      <div>
                        <p class="text-sm font-medium text-gray-900">
                          {{ room.variant_name }}
...
watch(
  () => props.groupData,
  async (newData) => {
    console.log("this is new", props.itemData, newData);
