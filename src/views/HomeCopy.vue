    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-4 mb-3">
      ...
      <div class="py-5 col-span-4 mt-4">
        <div class="grid grid-cols-1 md:grid-cols-1 gap-4 mb-3">
          <div
            class="bg-white/60 col-span-3 px-6 py-4 rounded-md shadow-sm backdrop-blur-lg backdrop-filter"
          >
            <div class="flex justify-between items-center">
              <div>
                <p
          ...
          <div class="bg-white/10 col-span-3">
            <div class="grid grid-cols-2 gap-6">
              <div
                class="py-6 rounded-md shadow-sm backdrop-blur-lg backdrop-filter px-3 bg-white/60"
              >
                <div class="flex justify-between items-center">
