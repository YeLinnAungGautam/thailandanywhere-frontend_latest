  ...
  <Layout>
    <div class="mb-5 w-full flex gap-x-6 items-center">
      ...
      <div
        ...
        class="pl-3 pr-4 me-7 py-2.5 bg-[#FF5B00] text-white cursor-pointer rounded-lg hover:bg-[#ff4400] transition-colors"
      >
      ...
      >
        <div class="flex justify-between items-center mb-5">
          <div class="flex gap-4">
            ...
            >
              <div class="flex items-center gap-2 mb-1">
                ...
                >
                <span v-else class="text-2xl font-medium text-black-800"
                  >0</span
                >
              </div>
          ...
          <div class="flex items-center gap-2">
            <div
              class="flex justify-center items-center border-2 shadow-md rounded-full overflow-hidden"
            >
              <div
                class="cursor-pointer px-4 py-2 text-xs"
                :class="
                  viewMode === 'grid' ? 'bg-[#ff613c] text-white' : 'bg-white'
                "
                @click="viewMode = 'grid'"
              >
                <svg
              ...
              <div
                ...
                @click="viewMode = 'list'"
                :class="
                  viewMode === 'list' ? 'bg-[#ff613c] text-white' : 'bg-white'
                "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  >
                    ...
                    >
                      <div class="grid grid-cols-6 gap-2 bg-white py-3">
                        ...
                        <div
                          class="flex items-center text-xs text-gray-700 whitespace-nowrap overflow-hidden"
                        >
                          {{ hotel.name }}
                        </div>
                        <div
                          class="flex items-center text-xs text-gray-700 whitespace-nowrap ps-6"
                        >
                          {{ hotel.city?.name }}
                        </div>
                        <div
                    ...
                    >
                      <div
                        v-if="expandedHotel === hotel.id"
                        class="w-full text-gray-500 bg-gray-50"
                      >
                        <div class="grid grid-cols-6 gap-2 bg-gray-300 py-2">
                          ...
                          <div
                            class="py-2 text-xs col-span-2 font-medium tracking-wide text-start pl-[7px]"
                          >
                            Room Name
                          </div>
                          <div
                        ...
                        >
                          ...
                          <div
                            class="p-2 text-xs col-span-2 text-start text-gray-700 whitespace-nowrap overflow-hidden pl-17"
                          >
                            <p>{{ room?.name }}</p>
                          </div>
                          <div
                            class="p-2 text-xs text-gray-700 whitespace-nowrap overflow-hidden"
                          >
                            <p
                          ...
                          <div
                            class="p-2 text-xs text-center text-gray-700 whitespace-nowrap overflow-hidden"
                          >
