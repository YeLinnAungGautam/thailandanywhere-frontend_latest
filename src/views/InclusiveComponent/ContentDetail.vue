...
<template>
  <div class="grid grid-cols-3 gap-6">
    <div class="col-span-2 space-y-3 pt-3">
      ...
      <div
        class="grid grid-cols-2 gap-4 pt-2 border border-gray-300 p-4 rounded-2xl"
      >
        <div
        ...
        >
          ...
          >
            ...
            <p class="text-sm">Day 1 : Missing Title</p>
          </div>
          <ChevronRightIcon class="w-4 h-4" />
        </div>
        <div class="space-y-2">
        ...
        <div class="space-y-2">
          <label for="" class="text-[12px] text-gray-500">Summary (eng)</label>
          <textarea
    ...
    <div class="pt-4">
      <div
        class="w-full h-[500px] bg-gray-300 rounded-2xl flex justify-center items-center"
      >
