  ...
  <div>
    <div>
      <div class="pb-4 border-b border-[#FF613c]">
        <p class="pb-2 text-xs">Expense Mail Status</p>
        ...
        <div class="p-4">
          ...
          <div class="grid grid-cols-3 gap-2">
            ...
            >
              <img
                :src="i.file"
                class="rounded-lg w-full h-auto bg-gray-100 border border-dashed border-[#FF613c] object-cover"
                alt=""
              />
              <div
...
const mailBodyChange = () => {
  ...
  is_expense_email_sent.value =
    props?.detail?.is_expense_email_sent == 1 ? true : false;
  ...
  if (props?.detail?.product_type == "App\\Models\\EntranceTicket") {
    ...
    <p class="p1">Please see our payment slip in the attached file for ${props?.detail?.crm_id}.</p><p class="p1"> We would like to kindly request a confirmation letter as soon as possible. Please kindly issue a receipt with Tax ID and send it to us by email.</p>
