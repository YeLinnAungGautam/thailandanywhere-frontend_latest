    ...
    <div class="space-y-6" v-if="!getLoading">
      <div class="flex justify-between items-center">
        <div class="flex justify-start items-center gap-x-2">
          ...
          <p
            class="text-xs flex justify-center items-center gap-x-2 text-white px-3 py-1.5 rounded-lg"
            :class="{
        ...
        <div class="col-span-2" v-if="!hide">
          <div class="flex justify-start items-start gap-x-4 pt-6">
            ...
            <div>
              ...
              <p class="text-base text-[#FF613c] pb-2">
                {{ detail?.product?.name }}
              </p>
      ...
      <div>
        ...
        <div class="flex justify-between pt-2 items-center">
          ...
          >
            <img
              src="https://cdn-icons-png.flaticon.com/128/10595/10595793.png"
              class="w-3 h-3 mr-1.5"
              alt=""
            />
            Booking
          ...
          >
            <img
              src="https://cdn-icons-png.flaticon.com/128/10595/10595794.png"
              class="w-3 h-3 mr-1.5"
              alt=""
            />
            Invoice
          ...
          >
            <img
              src="https://cdn-icons-png.flaticon.com/128/10595/10595795.png"
              class="w-3 h-3 mr-1.5"
              alt=""
            />
            Expense
          ...
          >
            <img
              src="https://cdn-icons-png.flaticon.com/128/11183/11183358.png"
              class="w-3 h-3 mr-1.5"
              alt=""
            />
            Confirm:
